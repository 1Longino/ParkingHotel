   ...
   String usuario;
    ...
    public void validarAcceso()
    {
        ...
        try
        {
            ...
            String sql="select * from empleados where nombre='"+usuario+"' and clave_empleado='"+password+"'";
            ...
            if(rs.next())
            {
                ...
                if(resultado==1)
                {
                    ...
                    empleadologeado=txtusuario.getText();
                    Principal p=new Principal(empleadologeado);
                    p.setVisible(true);
                    this.dispose();
        ...
        {
           JOptionPane.showMessageDialog(null,"Usuario Incorrecto Vuelva a Intentarlo"+e.getMessage()); 
        }
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hotel_estacionamiento/images.jpeg"))); // NOI18N
